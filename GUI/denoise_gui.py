...
class DenoiseGUI(tk.Tk):
    def __init__(self):
        ...
        self.exe_label = tk.Label(self.img_frame, text = f"Denoising executable path:")
    ...
    def on_denoise(self):
        ...
        try:
            ...
            print("Denoising output:", result.stdout)
            self.image = ImageTk.PhotoImage(Image.open(output_img))
            self.img_label.config(image=self.image)
